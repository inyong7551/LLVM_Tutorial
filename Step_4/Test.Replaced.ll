...
@.str.2 = private unnamed_addr constant [29 x i8] c"... %d PLUS %d PLUS %d = %d\0A\00", align 1

; Function Attrs: noinline nounwind optnone uwtable
define i32 @Add(i32*, i32*, i32*, i64) #0 {
  ...
  %subtmp = sub i32 %12, %16
  %17 = sext i32 %subtmp to i64
  %18 = load i64, i64* %8, align 8
  %subtmp1 = sub i64 %17, %18
  %19 = trunc i64 %subtmp1 to i32
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %9, i8* bitcast ([5 x i32]* @main.arr to i8*), i64 20, i32 16, i1 false)
  %10 = bitcast [5 x i32]* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %10, i8* bitcast ([5 x i32]* @main.brr to i8*), i64 20, i32 16, i1 false)
  %11 = getelementptr inbounds [5 x i32], [5 x i32]* %3, i32 0, i32 0
  %12 = getelementptr inbounds [5 x i32], [5 x i32]* %4, i32 0, i32 0
  %13 = getelementptr inbounds [5 x i32], [5 x i32]* %2, i32 0, i32 0
  %14 = load i32, i32* %1, align 4
  %15 = sext i32 %14 to i64
  %16 = call i32 @Add(i32* %11, i32* %12, i32* %13, i64 %15)
  ...
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i32 0, i32 0), i32 %20, i32 %24, i32 %25, i32 %26)
  ret i32 0
}
